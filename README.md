...
- ArgoCD CLI (optional)
- Redpanda cluster (for pipeline input/output. Get started [here](https://docs.redpanda.com/current/get-started/quick-start/) or try [Serverless](https://www.redpanda.com/product/serverless) free for 14 days.)
